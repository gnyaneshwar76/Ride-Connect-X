...
#
#   tools/evidence.sh call        # ring the phone while this runs
#   tools/evidence.sh message     # send yourself a WhatsApp / SMS
#   tools/evidence.sh navend      # start navigation, then end it
#   tools/evidence.sh heartbeat   # just leave it connected
#   tools/evidence.sh pairing     # force-stop and reopen the app
#   tools/evidence.sh telemetry   # capture a live frame
#
...
echo
echo "saved: $OUT"
echo "Paste the decisive lines into docs/Hardware-Evidence-Log.md"
