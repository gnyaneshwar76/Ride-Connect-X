...
Read with `docs/RideConnectX-Knowledge-Base.md` and `docs/PROJECT-STATUS.md`.
...
| `app/src/main/java/com/eshwar/rideconnectx/data/nav/MapsArrowCatalog.kt` | the 67 names, in the app |
