...
> Full write-up: `docs/HANDOFF.md` (17 Sep section) and
...
> **Read `docs/HANDOFF.md`, then `docs/Cluster-Test-2026-08-21.md`.**
>
...
> **Read `docs/Maps-Arrow-Decode-2026-08-20.md` first, then `docs/HANDOFF.md`.**
> Not yet wired in — held for the rider's signal.


**Living document. Update at the end of every working session.**

> **New chat? Read this first, then `docs/RideConnectX-Knowledge-Base.md`.**
...
2. ~~**Emulator pass.**~~ **DONE 13 August.** All six new screens walked end to
   ...
   the device. Full write-up: `docs/Emulator-Test-Report-2026-08-13.md`.
...
`tools/cluster-codes.csv` and the knowledge base.
...
**Worksheet:** `tools/sweep-1-52-worksheet.csv` — every code with its predicted
...
## ▶ START HERE — read `docs/HANDOFF.md` first

**`docs/HANDOFF.md` has the live state.** As of 17 August the build is green,
...
**Full write-up: `docs/Review-2026-08-16-Response.md`** — read that before
...
- **`img_promo_keyart` is written to `docs/store/`, not to `res/`.** It is Play
...
- `docs/Image-Prompts-Gemini.md` — 23 photographic image prompts, one per
...
- `docs/Figma-Brief.md` — the whole polish brief: locked colour and spacing
...
on the emulator the same day** — see `docs/Emulator-Test-Report-2026-08-13.md`
