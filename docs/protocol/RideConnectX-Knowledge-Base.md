...
Raw log: `tools/cluster/sweep-1-52-worksheet.csv` (Observed / Confirmed columns).
...
answered, every entry photographed. Raw log in `tools/cluster/cluster-codes.csv`.
...
`tools/cluster/cluster-codes.csv`. Code 38 is photographed.
