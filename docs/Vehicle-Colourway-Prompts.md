...
```
app/src/main/res/drawable-nodpi/img_vehicle_<vehicleId>_<colorId>.webp
```
...
```bash
python tools/images/prepare_vehicles.py --src "<folder of new PNGs>" --out app/src/main/res/drawable-nodpi
```
