...
order — see the 11 Sep section below and `docs/PROJECT-STATUS.md`.
...
2. **Deployed Firebase state is not source-visible.** Open Firebase Console -> Firestore
   -> Rules for the project in `app/google-services.json`, confirm the published rules
...
Lockito + Maps + real cluster, 3.5 km loop around Dammaiguda (`tools/rcx-hyd-loop.gpx`).
...
**The fix, pending the rider's eye:** the 18 Aug sweep (`tools/sweep-1-52-worksheet.csv`)
photographed **code 1 = junction-shaped turn LEFT** and **code 4 = its mirror, turn RIGHT**.
Plan: LEFT 37→1, RIGHT 35→4. Confirm by holding 1 and 4 (`tools/sweep-hold.sh 1`) or
...
**Read this first, then `docs/Maps-Arrow-Decode-2026-08-20.md`, then
`docs/PROJECT-STATUS.md` and `docs/RideConnectX-Knowledge-Base.md`.**
...
**`docs/Maps-Arrow-Decode-2026-08-20.md`**.
...
**Full write-up: `docs/Cluster-Test-2026-08-21.md`.**
